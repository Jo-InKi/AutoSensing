...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#Project"
            ...
            <i class="fas fa-fw fa-tools"></i><span>프로젝트 관리</span>
        </a>
        <div id="Project" class="collapse animated--grow-in" aria-labelledby="headingTwo" data-bs-parent="#accordionSidebar">
            <div class="toggled">
                <i class="fas fa-fw fa-tools"></i><span>프로젝트 관리</span>
            </div>
            <div class="bg-white collapse-inner">
                <a id="destTargetTab" class="collapse-item" href="/project/list?page=1">프로젝트 리스트</a>
            </div>
			<div class="bg-white collapse-inner">
			    <a id="destTargetTab" class="collapse-item" href="/project/list?page=1">센서 리스트</a>
			</div>
        </div>
    </li>
</ul>
