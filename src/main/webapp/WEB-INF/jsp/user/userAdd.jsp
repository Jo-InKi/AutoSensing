...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
		<form:form modelAttribute="projectAddForm" action="/user/register.do" method="post">
			<div class="table-responsive">
				<table class="table table-bordered" id="dataTable">
					<tbody>
					<tr>
						<th class="tg-0lax w-25 p-3" >사용자 등급&emsp;</th>
						<td class="tg-0lax">
					...
					<tr>
						...
						<td class="tg-0lax">
							<div class="input-group mb-3">
							<input type="text" class="form-control" id="userid" name="userid" size="32" maxlength="32" value="${user.userid }" oninput="resetIdDuplicateChk" placeholder="사용자 아이디" required>
							<button class="btn btn-outline-info" type="button" id="useridIDduplicate_check" onClick="userIdDuplicationCheck();" disabled>중복 확인</button>
