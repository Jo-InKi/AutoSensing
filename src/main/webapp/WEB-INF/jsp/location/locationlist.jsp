...
<div class="container-fluid">
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800" style="font-family:'IBM Plex Sans KR';">프로젝트 관리 > <span style="color:#0d6efd;">위치 관리</span></h1>
	<hr>
	<!-- DataTales Example -->
	<div class="card shadow mb-4">
		<div class="card-body">
			...
			<div class="input-group mb-3">
				...
				<a href="/location/add"><button type="button"
						class="btn btn-primary">위치 추가</button></a> <button
						...
						<table class="table table-bordered" id="dataTable">
							...
							<tbody>
							 <c:if test="${destList.size() == 0 }">
                            	...
                            	<c:forEach var="location" items="${locationList}" varStatus="location_index">
									<tr>
										<td class="col-sm-1 text-center align-middle">&emsp;&emsp;<input class="form-check-input"
										type="checkbox" value="${location.projectid}" id="rowCheck"
										name="rowCheck"></td>
